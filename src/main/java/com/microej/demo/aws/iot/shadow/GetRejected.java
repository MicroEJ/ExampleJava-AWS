...
/**
 * Executed when a shadow read fail. the message contains the failure details.
 */
@SuppressWarnings("nls")
public class GetRejected implements AwsIotMessageCallback {

	private static final Logger LOGGER = Logger.getLogger(GetRejected.class.getName());
