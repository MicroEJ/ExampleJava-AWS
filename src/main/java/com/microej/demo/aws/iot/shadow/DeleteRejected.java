...
/**
 * Executed when a shadow delete fail. the message contains the failure details.
 */
@SuppressWarnings("nls")
public class DeleteRejected implements AwsIotMessageCallback {

	private static final Logger LOGGER = Logger.getLogger(DeleteRejected.class.getName());
